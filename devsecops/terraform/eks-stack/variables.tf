...
variable "region" {
  ...
  validation {
    ...
    error_message = "The current support values are us-east-1 and us-west-2."
  }
}
...
// EKS AUTHENTICATION
# variable "ca_bundle" {
#   description = "Inform ca-bundle location."
#   type        = string
#   default     = " --ca-bundle /etc/ssl/certs/ca-certificates.crt "
# }
...
// TERRAFORM OBJECT TO CREATE SECURITY GROUP RULES

...
resource "aws_iam_policy" "ipv6_policy" {
  name        = "CustomEKS_CNI_Policy_IPv6Mode_${var.purpose}"
  path        = "/"
...
resource "aws_iam_role" "nodegroup_role" {
  name = "${var.purpose}-nodegroup-role"
...
resource "aws_iam_role_policy_attachment" "nodegroup_role_attachment_6" {
  role       = aws_iam_role.nodegroup_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMFullAccess"
}

resource "aws_iam_instance_profile" "ec2_profile" {
  name = "ec2_profile_${var.purpose}"
